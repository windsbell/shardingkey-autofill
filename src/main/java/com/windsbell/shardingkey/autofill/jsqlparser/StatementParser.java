...
/**
 * 核心API 抽象Statement解析器，解释SQL语法树各层级
 *
 * @author windbell
 */
public abstract class StatementParser implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {

    private static final String NOT_SUPPORTED_YET = "Not supported yet.";

    protected List<String> tables; // 解析的表集合

    @Getter
    protected Statement statement; // sql
    ...
    public void visit(Table tableName) {
        ...
        if (!tables.contains(tableWholeName.toLowerCase())) {
